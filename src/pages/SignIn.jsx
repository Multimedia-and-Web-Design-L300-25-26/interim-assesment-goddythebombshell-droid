// pages/SignIn.jsx — Sign in page
// Connects to GET /api/login on the backend and stores the JWT token on success.
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 flex flex-col">
      ...
      <div className="bg-yellow-50 border-b border-yellow-200 text-center py-2 px-4 text-sm text-yellow-800">
        Demo app – do not use your real password. This is a student project by Edward Larbi.
      </div>

      {/* Header with logo */}
      <div className="flex items-center justify-start px-6 py-6 border-b border-gray-200">
        <svg
          aria-label="CryptoApp logo"
          className="w-8 h-8"
          role="img"
          viewBox="0 0 48 48"
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-sm">
          ...
          <form className="space-y-5" onSubmit={handleSubmit} noValidate>
            ...
            {/* Password field — added for real authentication */}
            <div>
              <label
                htmlFor="password"
                className="block text-sm font-semibold text-gray-900 mb-2"
            ...
            {/* Social buttons (visual only — demo project) */}
            <div className="space-y-3">
              ...
              >
                <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0">
                  ...
                  <path fillRule="evenodd" clipRule="evenodd" d="M8.50017 5.38684C9.67471 5.38684 10.7293 5.79047 11.5583 6.5832L13.8529 4.28866C12.4674 2.99775 10.6565 2.20502 8.50017 2.20502C5.37289 2.20502 2.66744 3.99775 1.35107 6.61229L4.0238 8.68502C4.65289 6.79411 6.41653 5.38684 8.50017 5.38684Z" fill="currentColor" />
                </svg>
              ...
              <button
                ...
                className="w-full flex items-center gap-3 px-4 py-3 rounded-full bg-gray-100 hover:bg-gray-200 text-gray-900 font-semibold transition-colors"
              >
                <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0">
                  <title>Apple</title>
            ...
            <div className="text-center text-xs text-gray-500 pt-4">
              <p>
                Not your device? Use a private window to protect your account.
              </p>
            </div>
          </form>
        </div>
